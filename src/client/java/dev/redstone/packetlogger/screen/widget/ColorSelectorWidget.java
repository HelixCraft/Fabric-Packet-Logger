...
public class ColorSelectorWidget extends ClickableWidget {
    ...
    public void renderWidget(DrawContext context, int mouseX, int mouseY, float delta) {
        ...
        // Border
        dev.redstone.packetlogger.util.DrawUtil.drawBorder(context, boxX, boxY, BOX_SIZE, BOX_SIZE, 0xFF000000);

        // Hover-Effekt
        if (isMouseOverBox(mouseX, mouseY)) {
            dev.redstone.packetlogger.util.DrawUtil.drawBorder(context, boxX - 1, boxY - 1, BOX_SIZE + 2, BOX_SIZE + 2,
                    0xFFFFFFFF);
        }
    }
