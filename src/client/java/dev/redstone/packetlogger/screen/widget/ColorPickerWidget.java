...
public class ColorPickerWidget extends ClickableWidget {
    ...
    private void renderSVPicker(DrawContext context, int x, int y) {
        ...
        dev.redstone.packetlogger.util.DrawUtil.drawBorder(context, circleX - 4, circleY - 4, 8, 8, 0xFFFFFFFF);
        dev.redstone.packetlogger.util.DrawUtil.drawBorder(context, circleX - 3, circleY - 3, 6, 6, 0xFF000000);
    }
    ...
    private void renderHexAndPreview(DrawContext context, int x, int y, MinecraftClient client) {
        ...
        dev.redstone.packetlogger.util.DrawUtil.drawBorder(context, previewX, y, PREVIEW_SIZE, PREVIEW_SIZE,
                0xFF000000);
